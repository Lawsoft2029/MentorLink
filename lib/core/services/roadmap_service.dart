...
class RoadmapService {
  ...
  Future<void> initializeDynamicRoadmap() async {
    ...
    if (!doc.exists) {
      ...
      List<Map<String, dynamic>> dynamicMilestones = _getMilestonesForTrack(
        selectedTrack,
      );
  ...
  List<Map<String, dynamic>> _getMilestonesForTrack(String track) {
    ...
    if (lowerTrack.contains('flutter') || lowerTrack.contains('mobile')) {
      return [
        ...
        {
          'title': 'Phase 2: UI Layouts & Navigation Systems',
          'completed': false,
        },
        {'title': 'Phase 3: State Management Architecture', 'completed': false},
        {
          'title': 'Phase 4: Backend Integration & Authentication',
          'completed': false,
        },
        {
          'title': 'Phase 5: Local Caching & Offline Persistence',
          'completed': false,
        },
        {
          'title': 'Phase 6: Production Build, CI/CD & Deployment',
          'completed': false,
        },
      ];
    } else if (lowerTrack.contains('backend') ||
        lowerTrack.contains('cloud') ||
        lowerTrack.contains('firebase')) {
      return [
        {
          'title': 'Phase 1: Database Architecture & Collections Design',
          'completed': false,
        },
        {
          'title': 'Phase 2: Serverless Functions & Business Logic',
          'completed': false,
        },
        {
          'title': 'Phase 3: Security Rules & Identity Management',
          'completed': false,
        },
        {
          'title': 'Phase 4: API Design & Performance Optimization',
          'completed': false,
        },
        {
          'title': 'Phase 5: Monitoring, Analytics & Automated Backup',
          'completed': false,
        },
      ];
    } else {
      ...
      return [
        ...
        {
          'title': 'Phase 2: Version Control & Collaborative Workflows',
          'completed': false,
        },
        {
          'title': 'Phase 3: Software Design Patterns & Best Practices',
          'completed': false,
        },
        {
          'title': 'Phase 4: Testing, Debugging & QA Protocols',
          'completed': false,
        },
        {
          'title': 'Phase 5: Final Capstone Project & Deployment',
          'completed': false,
        },
      ];
    }
