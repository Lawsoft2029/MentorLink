...
class EnterpriseRegistrationScreen extends StatefulWidget {
  ...
  @override
  State<EnterpriseRegistrationScreen> createState() =>
      _EnterpriseRegistrationScreenState();
}

class _EnterpriseRegistrationScreenState
    extends State<EnterpriseRegistrationScreen> {
  ...
  void _submitEnterpriseRegistration() async {
    ...
    try {
      ...
      if (regNo.length < 5) {
        throw Exception(
          "Invalid registration number. Must be at least 5 characters.",
        );
      }
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text(
              "Business verified and enterprise registration submitted successfully!",
            ),
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              "Verification/Submission failed: ${e.toString().replaceAll('Exception: ', '')}",
            ),
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                  labelText: "Company / Startup Name",
              ...
              DropdownButtonFormField<String>(
                ...
                decoration: const InputDecoration(
                  labelText: "Legal Jurisdiction / Registry",
                  border: OutlineInputBorder(),
                ),
                items:
                    [
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                  labelText: "Registration Number (e.g., RC-123456)",
                  border: OutlineInputBorder(),
                ),
                validator: (val) =>
                    val!.isEmpty ? 'Please enter registration ID' : null,
              ),
              const SizedBox(height: 16),
              TextFormField(
                controller: _corporateEmailController,
                decoration: const InputDecoration(
                  labelText: "Corporate Domain Email",
                  border: OutlineInputBorder(),
                ),
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                  labelText: "Required Team Seat Licenses (e.g., 10)",
                  border: OutlineInputBorder(),
                ),
                validator: (val) =>
                    val!.isEmpty ? 'Please enter seat count' : null,
              ),
              ...
              ElevatedButton(
                ...
                child: _isLoading
                    ...
                    : const Text(
                        "Submit for Enterprise Verification",
