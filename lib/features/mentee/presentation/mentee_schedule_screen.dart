...
class MenteeScheduleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('My Learning Roadmaps', style: TextStyle(fontWeight: FontWeight.bold)),
      ...
      body: uid == null
          ...
          : StreamBuilder<DocumentSnapshot>(
              ...
              builder: (context, userSnapshot) {
                ...
                final List<dynamic> enrolledCourseIds = userData['enrolledCourses'] ?? [];
                final Map<String, dynamic> courseTimelines = userData['courseTimelines'] ?? {};
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return FutureBuilder<DocumentSnapshot>(
                      ...
                      builder: (context, courseSnapshot) {
                        ...
                        final title = courseData['courseTitle'] ?? 'Tech Course';
                        final description = courseData['description'] ?? 'Active engineering track.';
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                const LinearProgressIndicator(
                                  value: 0.25, // Example progress (e.g. Month 2 of 6)
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    TextButton.icon(
                                      onPressed: () {
                                        // Action to discuss schedule with course mentors
                                        ScaffoldMessenger.of(context).showSnackBar(
                                          SnackBar(content: Text("Opening mentorship schedule for $title")),
                                        );
                                      },
                                      icon: const Icon(Icons.calendar_month, size: 16, color: primaryColor),
                                      label: const Text("Discuss Schedule", style: TextStyle(color: primaryColor)),
                                    ),
                                  ],
                                ),
                              ],
