...
class _MenteeDiscoveryScreenState extends State<MenteeDiscoveryScreen> {
  String? _selectedCourseFilter; // Filter mentors by selected dynamic course tag
                    ...
                    Padding(
                      ...
                      child: ChoiceChip(
                        ...
                        labelStyle: TextStyle(
                          color: _selectedCourseFilter == null ? Colors.white : Colors.black87,
                    ...
                    ...courses.map((doc) {
                      ...
                      return Padding(
                        ...
                        child: ChoiceChip(
                          ...
                          selectedColor: primaryColor,
                          labelStyle: TextStyle(
                            color: _selectedCourseFilter == courseTitle ? Colors.white : Colors.black87,
                            fontWeight: FontWeight.bold,
                          ),
                          onSelected: (selected) {
                            setState(() {
                              _selectedCourseFilter = selected ? courseTitle : null;
                            });
                          },
                        ),
                      );
            ...
            child: StreamBuilder<QuerySnapshot>(
              stream: () {
                ...
                if (_selectedCourseFilter != null) {
                  query = query.where('expertiseTag', isEqualTo: _selectedCourseFilter);
                }
